...
class BetterSocialSharingButtonsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $social_services = [
      ...
      'reddit' => t('Reddit'),
      'evernote' => t('Evernote'),
      'copy' => t('Copy current page url to clipboard'),
    ];

    $form['services'] = [
      '#title' => t('Select which social sharing buttons you would like to use'),
      '#type' => 'checkboxes',
      '#description' => t('Check the services for which you would want social sharing buttons to appear'),
    ...
    $form['iconset'] = array(
      '#type' => 'radios',
      '#title' => t('Which iconset do you want to use ?'),
      '#default_value' => \Drupal::state()->get('iconset') ?: 'social-icons--square',
      '#required' => TRUE,
      '#options' => array(
        'social-icons--square' => t('Colored square icons (you can adjust the border radius)<br>
        ...
        ...
        '),
        'social-icons--no-color' => t('Icons without color or background (you can use svg fill property in css to alter the icon color)<br/>
    ...
    $form['facebook_app_id'] = [
      ...
      '#description' => t('If you want to share to FB messenger, a Facebook App Id is required'),
      '#states'        => array(
        'visible'      => array(
    ...
    $form['width'] = [
      ...
      '#description' => t('Set the width of the icons in pixels, like 32px'),
      '#required' => TRUE,
      '#weight' => $weight,
    ];
    $weight++;
    ...
    $form['height'] = [
      ...
      '#description' => t('Set the height of the icons in pixels, like 32px'),
      '#required' => TRUE,
      '#weight' => $weight,
    ];
    $weight++;
    ...
    $form['radius'] = [
      ...
      '#description' => t('Set the border radius of each icon (=rounded corners). Set to 0px to have square icons or 100% to convert the square icons into circular icons'),
      '#required' => TRUE,
      '#weight' => $weight,
    ];
    $weight++;
